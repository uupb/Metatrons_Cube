...
void main() {
   ...
   // Outer Ring
    ...
    if (d0 < 0.0) color += vec3(sin(time), cos(time), sin(time * 108.0)) * (0.5 - smoothstep(0.0, glowIntensity, -d0));
    // Inner
    ...
    if (d5 < 0.0) color += vec3(sin(time), cos(time * 12.0), sin(time * 12.0)) * (0.5 - smoothstep(0.0, glowIntensity, -d5));
    if (d6 < 0.0) color += vec3(sin(time), cos(time * 15.0), sin(time * 15.0)) * (0.5 - smoothstep(0.0, glowIntensity, -d6));
    // Outer
    if (d7 < 0.0) color += vec3(cos(time), sin(time * 15.0), cos(time * 15.0)) * (0.5 - smoothstep(0.0, glowIntensity, -d7));
    if (d8 < 0.0) color += vec3(sin(time * 12.0), cos(time * 12.0), sin(time)) * (0.5 - smoothstep(0.0, glowIntensity, -d8));
    if (d9 < 0.0) color += vec3(cos(time * 9.0), sin(time), cos(time * 9.0)) * (0.5 - smoothstep(0.0, glowIntensity, -d9));
    if (d10 < 0.0) color += vec3(sin(time), cos(time * 7.0), sin(time * 7.0)) * (0.5 - smoothstep(0.0, glowIntensity, -d10));
    if (d11 < 0.0) color += vec3(sin(time), cos(time * 5.0), sin(time)) * (0.5 - smoothstep(0.0, glowIntensity, -d11));
    if (d12 < 0.0) color += vec3(sin(time), cos(time * 3.0), sin(time)) * (0.5 - smoothstep(0.0, glowIntensity, -d12));
