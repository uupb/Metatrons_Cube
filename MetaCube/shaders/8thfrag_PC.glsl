...
void main() {
    ...
    if (d1 < 0.0) color += vec3(sin(time), cos(time), sin(time * 12.0)); // Variable color inside hexagon 1
    if (d2 < 0.0) color += vec3(cos(time), sin(time * 3.0), cos(time)); // Variable color inside hexagon 2
    if (d3 < 0.0) color += vec3(sin(time * 5.0), cos(time), sin(time)); // Variable color inside hexagon 3
    if (d4 < 0.0) color += vec3(cos(time * 7.0), sin(time), cos(time * 7.0)); // Variable color inside hexagon 4
    if (d5 < 0.0) color += vec3(sin(time), cos(time * 9.0), sin(time * 9.0)); // Variable color inside hexagon 5
